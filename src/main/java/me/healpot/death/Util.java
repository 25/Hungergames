...
public class Util {
    ...
    private static double addEnchants(ItemStack[] armor, double damage, EntityDamageEvent.DamageCause damageCause) {
    ...
    public static double calculateDamageAddArmor(ItemStack[] armor, EntityDamageEvent.DamageCause damageCause, double damage) {
        return calculateDamageAddArmor(armor, damageCause, damage, false, null);
    }

    public static double calculateDamageAddArmor(ItemStack[] armor, EntityDamageEvent.DamageCause damageCause, double damage, boolean blocking) {
    ...
    public static double calculateDamageAddArmor(ItemStack[] armor, EntityDamageEvent.DamageCause damageCause, double damage, boolean blocking,
        ...
        if (resistancePotionEffect != null && damageCause != EntityDamageEvent.DamageCause.VOID) {
    ...
    public static double calculateDamageAddArmor(Player player, EntityDamageEvent.DamageCause damageCause, double damage) {
     ...
     */
    public static double calculateDamageRemoveArmor(ItemStack[] armor, EntityDamageEvent.DamageCause damageCause, double damage) {
     ...
     * Remember. Damage events feed the RAW damage. Not the armor damage!
     */
    public static double calculateDamageRemoveArmor(ItemStack[] armor, EntityDamageEvent.DamageCause damageCause, double damage, boolean blocking) {
    ...
    public static double calculateDamageRemoveArmor(Player player, EntityDamageEvent.DamageCause damageCause, double damage) {
        PotionEffect effect = null;
    ...
    private static int getEnchantRating(ItemStack[] items, EntityDamageEvent.DamageCause damageCause) {
        int rating = 0;
        for (ItemStack item : items) {
            if (item == null) {
                continue;
