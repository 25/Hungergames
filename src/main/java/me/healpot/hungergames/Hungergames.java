...
import me.healpot.death.DeathHandler;
import me.healpot.hungergames.configs.MainConfig;
import me.healpot.hungergames.configs.TranslationConfig;
import me.healpot.hungergames.events.*;
import me.healpot.hungergames.listeners.GeneralListener;
import me.healpot.hungergames.listeners.InventoryListener;
import me.healpot.hungergames.listeners.LibsFeastManager;
import me.healpot.hungergames.listeners.PlayerListener;
...
import me.healpot.hungergames.types.CustomDeathCause;
...
import me.healpot.hungergames.utilities.ActionBar;
import me.healpot.hungergames.utilities.MapLoader;
import me.healpot.hungergames.utilities.Title;
...
public class Hungergames extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if (Bukkit.getPluginManager().getPermission("ThisIsUsedForMessaging") == null) {
            ...
            perm.setDescription("Used for messages in Hungergames");
    ...
    public void startGame() {
        ...
        world.playSound(world.getSpawnLocation(), Sounds.AMBIENCE_THUNDER.bukkitSound(), 1, 0.8F);
        Bukkit.getScheduler().scheduleSyncDelayedTask(this, new Runnable() {
            public void run() {
